...
function [S, myMovie, count_frame]= sparsenet(IMAGES,A,count,count_frame,myMovie)
...
display_every=250; %10

h=display_network(A,S_var,[],S,count,[]);
...
%         [~,thisFrame]= display_network(A,S_var,h,S,count,t);
%     
%     %if mod(t,100)==0 || t==1
%         myMovie(count_frame) = thisFrame;
%         count_frame= count_frame+1;
%     %end
%     
%     end
