function GameBoard(X_position_mouse,Y_position_mouse,platform_cordinate,cat_cordinate,d_mouse,cheese_cordinate)
...
hold on
d= imread('D:\Zahra\111MyLesson\Ad_Neuro\Homework\HW06_new\cheese.jpg');
image(flipud(d), 'XData', [cheese_cordinate(1) cheese_cordinate(1)+1],...
    'YData', [cheese_cordinate(2) cheese_cordinate(2)+1]);
hold on
